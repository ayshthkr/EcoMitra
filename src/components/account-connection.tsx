...
export function AddBankAccountComponent({
  ...
  async function handleNext() {
    ...
    } else if (step === 2 && isValidAccountDetails()) {
      setStep(3); // Column mapping
    } else if (step === 3 && isValidMapping() && csvFile) {
      try {
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div className="grid gap-4">
                ...
                {/* Currency Select removed and replaced with informational text */}
                <div className="grid gap-2">
          ...
          <div className="flex justify-between mt-6">
            ...
            <Button
              ...
              disabled={
                isLoading ||
                (step === 1 && !csvFile) ||
                (step === 2 && !isValidAccountDetails()) ||
                (step === 3 && !isValidMapping())
              }
            >
              {isLoading ? (
                <>
